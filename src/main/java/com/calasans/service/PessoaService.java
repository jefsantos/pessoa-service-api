...
import com.calasans.model.ResponseModel;
import com.calasans.repository.PessoaRepository;
...
public class PessoaService {
	...
	public @ResponseBody ResponseModel salvar(@RequestBody PessoaModel pessoa){
		...
		try {
			...
			return new ResponseModel(1,pessoa.getNome() + " salvo com sucesso!");
	...
	public @ResponseBody ResponseModel atualizar(@RequestBody PessoaModel pessoa){
		...
		try {
			...
			return new ResponseModel(1, pessoa.getNome() + " Registrado com Atualizado com Sucesso");
	...
	public @ResponseBody ResponseModel excluir(@PathVariable("codigo") Integer codigo){
		...
		try {
			...
			return new ResponseModel(1, pessoaModel.getNome() + " excluido com sucesso!");
